...
from core.views import WilayaViewSet, StoreSettingsViewSet, HomepageContentViewSet, AnalyticsAPIView, LookbookItemViewSet
...
router.register(r'lookbook', LookbookItemViewSet)
