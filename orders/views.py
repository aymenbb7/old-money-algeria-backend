...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def checkout(self, request):
        ...
        if not wilaya.is_active:
            return Response({'error': 'Delivery to this wilaya is currently disabled.'}, status=status.HTTP_400_BAD_REQUEST)
        ...
        for item in items_data:
            ...
            if variant.stock < qty:
                ...
                return Response({'error': f'Not enough stock for {variant}'}, status=status.HTTP_400_BAD_REQUEST)
